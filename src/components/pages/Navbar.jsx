...
const Navbar = ({ showLogin, setShowLogin, user, handleLogout }) => {
    ...
    const fetchSuggestions = async () => {
      ...
      try {
        const response = await fetch(
          `https://quickcart-02mk.onrender.com/api/products?search=${searchTerm}`
        );
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const res = await fetch("https://quickcart-02mk.onrender.com/api/user/profile", {
        ...
        <div className="toast-notification">
          <div className="toast-content">
            <div className="toast-message">
              ...
              <CheckCircle fill="#10b981" color="white" size={24} />
              {toast.message}
            </div>
            <button
        ...
        <div className="search-container">
          <div className="search-box">
            ...
            <input
              type="text"
              id="se"
              placeholder='Search "butter, milk"'
        ...
        <div className="nav-right">
          {!user ? (
            ...
            <div className="profile-container" ref={profileMenuRef}>
              ...
              {showProfileMenu && (
                <div className="profile-dropdown redesigned">
                  ...
                  <div className="profile-user-card">
                    ...
                    <div className="user-meta">
                      <h4 className="user-name">{user.name || "My Account"}</h4>
                      <p className="user-phone">{user.phoneNumber}</p>
                    </div>
                  </div>

                  {/* Section 2: Quick Stats or Admin Role */}
                  {user?.role === "admin" && (
                    <div
                  ...
                  <div className="profile-menu-links">
                    ...
                    >
                      ...
                      <div className="menu-text-group">
                        <span className="menu-label">Saved Addresses</span>
                        <span className="menu-sublabel">
